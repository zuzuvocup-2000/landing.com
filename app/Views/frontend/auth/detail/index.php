        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 hidden-xs hidden-sm sidebar sidebar-left" >
                    <div class="wrapper" data-uk-sticky="{top: 25}">
                        <div class="title clearfix">
                            Xin Chào, Lê Việt Anh
                        </div>
                        <ul class="list-menu">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6 col-xs-12">
                                            ...
                                            <div class="form-group">
                                                <div>Tên của bạn:</div>
                                                <input type="text" class="form-control" name="fullname" placeholder="Họ và tên" value="" required />
                                            </div>
                                            <div class="form-group">
                                                <div>Email: </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="phone" placeholder="Số điện thoại" value="0523591685" required />
                                            </div>
                                            <div class="form-group">
                                                <div>Địa chỉ Facebook</div>
                                                <input type="text" class="form-control" name="facebook_link" placeholder="https://facebook.com/user" value="" />
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-xs-12">
                                        	<div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <div>Địa chỉ</div>
                                                <input type="text" class="form-control" name="address" placeholder="Địa chỉ" value="" required />
                                            </div>
                                            <div class="form-group">
                                                <div>Địa chỉ Instagram</div>
                                                <input type="text" class="form-control" name="instagram_link" placeholder="https://instagram.com/user" value="" />
                                            </div>
                                        </div>
                                    </div>
                                    <button type="submit" class="btn btn-danger btn-submit-update-profile">Cập nhật</button>
                                </form>
                            </div>
                        </div>
                    </div>
